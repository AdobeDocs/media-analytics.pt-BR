...
| Recurso | Descrição | Data alvo |
| ----------- | ---------- | ------- |
| Rastreamento de vários estados do player | Use a API de coleção de mídia para implementar o rastreamento de vários estados do player. [Saiba mais](/help/use-cases/player-state-tracking/multiple-player-states.md) | Setembro de 2022 |
