...
| Estação | media.mediaTimed.primaryAssetReference.id3.Audio.id3.TRSN | mediaReporting.sessionDetails.station | Dimensão | Estação |                                                                       |
...
| Nome do campo | Caminho atual do campo XDM (obsoleto) | Caminho do campo XDM do relatório | Tipo de dados | Campo derivado | Notas |
|------------------|--------------------------------------------------------------|------------------------------------------------|-----------|----------------|-----------|
| ID do anúncio | advertising.adAssetReference.id | mediaReporting.advertisingDetails.name | Dimensão | ID do anúncio |           |
