...
Para obter mais informações sobre como implementar o Media no Edge, consulte [Instalar a coleção de mídia de streaming com o Experience Platform Edge](/help/implementation/edge/overview.md).
