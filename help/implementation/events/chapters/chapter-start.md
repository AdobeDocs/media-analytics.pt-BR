...
Crie um objeto de capítulo com `adb_media_init_chapterinfo` e rastreie o evento:
...
Enviar uma POSTAGEM `chapterStart` para o [ponto de extremidade de eventos](https://developer.adobe.com/analytics-collection-apis/methods/media-collection/events):
