...
Para permitir relatórios no Analytics e visualizar os dados de conteúdo e anúncios coletados, é necessário habilitar os relatórios no Analytics. Consulte [Ativação de relatórios de mídia](/help/implementation/media-sdk/setup/media-reports-enable.md).
