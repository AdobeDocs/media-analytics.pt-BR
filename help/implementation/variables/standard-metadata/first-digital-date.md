...
Use `MEDIA_VideoMetadataKeyFIRST_DIGITAL_DATE` para definir a primeira data digital nos metadados padrão do objeto de mídia antes de chamar `mediaTrackSessionStart`:
