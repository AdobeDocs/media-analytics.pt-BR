...
Passe a contagem cumulativa de quadros ignorados como o quarto argumento (`droppedFrames`) para `adb_media_init_qosinfo` e atualize o rastreador com `mediaUpdateQoS`:
