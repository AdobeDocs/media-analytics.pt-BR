...
| **Campo da coleção XDM** | [`xdm.mediaCollection.qoeDataDetails.timeToStart`](https://experienceleague.adobe.com/pt-br/docs/experience-platform/xdm/data-types/qoe-data-details-collection) |
...
Passe o tempo de inicialização como segundo argumento (`startupTime`) para `adb_media_init_qosinfo` e atualize o rastreador com `mediaUpdateQoS`:
