...
| **Campo da coleção XDM** | [`xdm.mediaCollection.advertisingDetails.creativeURL`](https://experienceleague.adobe.com/pt-br/docs/experience-platform/xdm/data-types/advertising-details-collection) |
...
Definir `creativeURL` dentro de `xdm.mediaCollection.advertisingDetails` ao chamar [`sendEvent`](https://experienceleague.adobe.com/pt-br/docs/experience-platform/collection/js/commands/sendevent/overview):
...
Definir `creativeURL` dentro de `xdm.mediaCollection.advertisingDetails` ao chamar `sendMediaEvent` para `media.adStart`:
...
Chame o ponto de extremidade [adStart](https://developer.adobe.com/data-collection-apis/docs/endpoints/media/ads/#adstart) com `creativeURL` dentro de `xdm.mediaCollection.advertisingDetails`:
...
Defina a URL de criação usando `ADBMobile.media.AdMetadataKeys.CREATIVE_URL` no objeto de metadados de anúncio padrão:
...
Defina a URL de criação usando `MEDIA_AdMetadataKeyCREATIVE_URL` no objeto de metadados de anúncio padrão:
