...
A API Media Collection é essencialmente um adaptador e atua como uma versão no lado do servidor do SDK do Media. Os dados de rastreamento de streaming de mídia coletados levam aos mesmos [Relatórios e Análise](/help/implementation/media-sdk/setup/media-reports-enable.md).
...
Para obter a lista completa de tipos de evento com exemplos de implementação por SDK, consulte a [Visão geral dos eventos](/help/implementation/events/overview.md).
