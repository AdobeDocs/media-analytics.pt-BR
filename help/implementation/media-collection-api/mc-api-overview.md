...
A API Media Collection é essencialmente um adaptador e atua como uma versão no lado do servidor do SDK do Media. Os dados de rastreamento de streaming de mídia coletados levam aos mesmos [Relatórios e Análise](/help/reporting/setup/analytics-reporting.md).
