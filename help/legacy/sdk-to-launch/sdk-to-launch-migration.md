...
entre o Media SDK independente e a extensão do Media Analytics Launch.

O Launch oferece aos clientes uma forma simples de implantar e gerenciar todas as análises,
marketing e publicidade necessárias para potencializar clientes relevantes
experiências na web e em dispositivos móveis. O Launch capacita qualquer um a criar e manter
suas próprias integrações com o Launch. Essas integrações são chamadas de extensões.
As extensões estão disponíveis para os clientes do Launch em uma experiência de loja de aplicativos, para que
O pode instalar, configurar e implantar suas soluções com rapidez.
