...
+ [Medição de áudio e vídeo no Adobe Analytics](media-overview.md)
+ Measurement Options {#measurement-options}
   + Media Module Milestone Tracking {#mm-milestone-tracking}
      ...
      + [Migrar marco para o Media Analytics](measurement-options/mm-milestone-tracking/migrate-ms-to-va.md)
...
+ SDK do Media Analytics {#sdk-implement}
   ...
   + Rastrear a reprodução de áudio e vídeo {#track-av-playback}
      ...
      + Track Core Audio and Video Playback {#track-core}
         ...
         + [Rastrear reprodução principal no javascript](sdk-implement/track-av-playback/track-core/track-core-js.md)
      ...
      + Track Buffering {#track-buffering}
         + [Acompanhar buffering no Android](sdk-implement/track-av-playback/track-buffering/track-buffering-android.md)
         + [Acompanhar buffering no iOS](sdk-implement/track-av-playback/track-buffering/track-buffering-ios.md)
         + [Acompanhar buffering no javascript](sdk-implement/track-av-playback/track-buffering/track-buffering-js.md)
         + [Acompanhar buffering no Chromecast](sdk-implement/track-av-playback/track-buffering/track-buffering-chromecast.md)
         + [Acompanhar buffering no Roku](sdk-implement/track-av-playback/track-buffering/track-buffering-roku.md)
      + Track Seeking {#track-seeking}
         + [Rastrear busca no Android](sdk-implement/track-av-playback/track-seeking/track-seeking-android.md)
         + [Rastrear busca no iOS](sdk-implement/track-av-playback/track-seeking/track-seeking-ios.md)
         + [Rastrear busca no javascript](sdk-implement/track-av-playback/track-seeking/track-seeking-js.md)
         + [Rastreamento de busca no Chromecast](sdk-implement/track-av-playback/track-seeking/track-seeking-chromecast.md)
         + [Rastrear busca no Roku](sdk-implement/track-av-playback/track-seeking/track-seeking-roku.md)
      + Implementar metadados padrão {#impl-std-metadata}
         ...
         + [Teclas de metadados do iOS](sdk-implement/track-av-playback/impl-std-metadata/ios-metadata-keys.md)
         ...
         + [Parâmetros padronizados de metadados - Roku](sdk-implement/track-av-playback/impl-std-metadata/roku-metadata.md)
   + Rastreamento de anúncios {#track-ads}
      ...
      + [Rastreamento de anúncios no Chromecast](sdk-implement/track-ads/track-ads-chromecast.md)
   ...
   + Rastrear a qualidade da experiência {#track-qos}
      ...
      + [Rastrear qualidade da experiência no Android](sdk-implement/track-qos/track-qos-android.md)
      + [Rastrear qualidade da experiência no iOS](sdk-implement/track-qos/track-qos-ios.md)
      + [Rastrear qualidade da experiência no javascript](sdk-implement/track-qos/track-qos-js.md)
      + [Acompanhar qualidade da experiência no Chromecast](sdk-implement/track-qos/track-qos-chromecast.md)
      + [Acompanhar qualidade da experiência no Roku](sdk-implement/track-qos/track-qos-roku.md)
   + Track Errors {#track-errors}
      + [Visão geral](sdk-implement/track-errors/track-errors-overview.md)
      + [Monitoramento de erros no Android](sdk-implement/track-errors/track-errors-android.md)
      + [Rastrear erros no iOS](sdk-implement/track-errors/track-errors-ios.md)
      + [Monitoramento de erros no javascript](sdk-implement/track-errors/track-errors-js.md)
      + [Acompanhar erros no Chromecast](sdk-implement/track-errors/track-errors-chromecast.md)
      + [Monitoramento de erros no Roku](sdk-implement/track-errors/track-errors-roku.md)
   ...
   + Guia {#cookbook}
      ...
      + [Retomada de sessões inativas](sdk-implement/cookbook/resuming-inactive.md)
      + [Rastreamento no SceneGraph (Roku)](sdk-implement/cookbook/sdk-track-scenegraph.md)
      + [SDK e diferenças de inicialização](sdk-implement/cookbook/sdk-vs-launch-qoe.md)
...
+ API de coleta de mídia (resttly) {#media-collection-api}
   ...
   + [Rastrear conteúdo baixado](media-collection-api/track-downloaded-content.md)
...
+ Reporting and Analysis {#media-reports}
   + [Ativação dos relatórios de mídia](media-reports/media-reports-enable.md)
   ...
   + [Modelos da Workworkspace](media-reports/media-workspace-templates.md)
