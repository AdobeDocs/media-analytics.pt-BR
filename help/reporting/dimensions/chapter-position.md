...
A posição do capítulo é definida pelo reprodutor em cada evento `media.chapterStart`.
...
Cada item é o valor de posição inteiro relatado em `media.chapterStart`.
