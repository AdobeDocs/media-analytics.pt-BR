...
O comprimento do capítulo é definido pelo reprodutor em cada evento `media.chapterStart`.

| Sistema de relatório | Origem |
| --- | --- |
| Adobe Analytics (regra de processamento) | Crie uma [Regra de processamento](https://experienceleague.adobe.com/en/docs/analytics/admin/admin-tools/manage-report-suites/edit-report-suite/report-suite-general/processing-rules/pr-overview) que mapeie `a.media.chapter.length` para uma eVar. |
...
Cada item é o valor de comprimento inteiro, em segundos, reportado em `media.chapterStart`.
