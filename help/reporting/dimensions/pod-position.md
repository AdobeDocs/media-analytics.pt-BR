...
A posição do pod é definida com base no valor de [Tempo de início de ad break](/help/implementation/variables/ads/ad-break-start-time.md) que o player define em [início de ad break](/help/implementation/events/ads/ad-break-start.md).
...
| Customer Journey Analytics | [`mediaReporting.advertisingPodDetails.offset`](https://experienceleague.adobe.com/pt-br/docs/experience-platform/xdm/data-types/advertising-pod-details-reporting) |
...
Cada item é o valor de deslocamento inteiro (em segundos) relatado em [ad break start](/help/implementation/events/ads/ad-break-start.md).
