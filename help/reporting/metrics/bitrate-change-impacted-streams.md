...
O back-end de mídia define esse sinalizador na primeira vez que um evento de [alteração de taxa de bits](/help/implementation/events/playback/bitrate-change.md) é recebido durante a sessão. A métrica é relatada na chamada de fechamento.
