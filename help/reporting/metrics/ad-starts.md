...
O back-end de mídia define `mediaReporting.advertisingDetails.isStarted = true` quando um evento `media.adStart` é recebido. A métrica é relatada na chamada de início do anúncio.
...
| Customer Journey Analytics | [`mediaReporting.advertisingDetails.isStarted`](https://experienceleague.adobe.com/pt-br/docs/experience-platform/xdm/data-types/advertising-details-reporting) |
