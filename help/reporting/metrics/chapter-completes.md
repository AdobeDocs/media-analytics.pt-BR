...
| --- | --- |
| Adobe Analytics | Coletado automaticamente dos dados de contexto `a.media.chapter.complete` quando [[!UICONTROL Capítulos de mídia]](/help/reporting/setup/analytics-reporting.md) está habilitado. |
